...
const About = () => {
  return (
    <section>
      <div className="bg-white md:rounded-md md:w-[80vw] md:mx-auto p-8 md:justify-between md:px-16 shadow-lg my-10 relative flex flex-col gap-[24px] md:flex-row">
        <div className="flex flex-col gap-5 md:justify-center md:w-[50%]">
          <div className="absolute -top-10 right-10 md:-left-6 md:-top-14">
            <Image className="w-[100px]" src="/AboutIcon.svg" />
          </div>
          <h4 className="text-secondary text-[38px] font-semibold leading-[2.75rem] w-[50%]">
            Sobre{" "}
            <span className="text-primary md:text-secondary">nosotros</span>
          </h4>
